...
#Check out the servername and the version in the container, 2019-CU14
...
ssh -t aen@c1-storage 'sudo chown -R 10001:10001 /export/volumes/sql/'
ssh -t aen@c1-storage 'sudo chown -R 10001:10001 /export/volumes/sql/{backup,system,data,log}'
