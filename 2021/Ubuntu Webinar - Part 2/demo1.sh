...
ssh aen@webinar1.nocentino.lab
...
adutil spn addauto -n sqluser -s MSSQLSvc -H webinar1.nocentino.lab -p 1433 -y
...
adutil keytab createauto -k mssql.keytab -p 1433 -H webinar1.nocentino.lab --password 'P@ssw0rd' -s MSSQLSvc -e aes256-cts-hmac-sha1-96,aes128-cts-hmac-sha1-96,aes256-cts-hmac-sha384-192,aes128-cts-hmac-sha256-128,des3-cbc-sha1,arcfour-hmac -y
...
ssh -l aen@nocentino.lab webinar1.nocentino.lab
...
sqlcmd -S webinar1.nocentino.lab
