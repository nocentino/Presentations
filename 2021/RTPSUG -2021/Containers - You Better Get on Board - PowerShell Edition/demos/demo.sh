...
cd ~/Dropbox/Talks/Containers\ -\ You\ Better\ Get\ on\ Board\ -\ PowerShell\ Edition/demos

#Pull a container, discuss layers. 
...
docker image inspect mcr.microsoft.com/mssql/server:2019-CU13-ubuntu-18.04 | less
...
docker run \
    ...
    --name 'sql1' \
    -p 1433:1433 \
    -d mcr.microsoft.com/mssql/server:2019-CU13-ubuntu-18.04
