...
ssh -t aen@c1-storage 'sudo ls -la /srv/exports/volumes/sql-instance-2/system' 
ssh -t aen@c1-storage 'sudo ls -la /srv/exports/volumes/sql-instance-2/data'
...
ssh -t aen@c1-storage 'sudo mkdir -p /srv/exports/volumes/sql-instance-2/{backup,system,data,log}'
ssh -t aen@c1-storage 'sudo chown mssql:mssql -R /srv/exports/volumes/sql-instance-2'
ssh -t aen@c1-storage 'sudo ls -laR /srv/exports/volumes/sql-instance-2'
