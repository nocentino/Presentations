...
#Check out the servername and the version in the container, 2019 CU8
...
#Change out the version of SQL Server from CU8->CU9, could use YAML or kubectl edit too
kubectl set image deployment mssql-deployment \
    mssql=mcr.microsoft.com/mssql/server:2019-CU9-ubuntu-18.04 --record
